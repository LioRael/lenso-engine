...
export const CAPABILITY_ID = "lenso.terminal.command@1";
export const DESCRIPTOR_VERSION = "1.0.0";
export const DESCRIPTOR_DIGEST = "sha256:7793d8a35c0874568625545652b8773092f63b98a70a32f05a0d82e417006b3b";
...
export const Command: CapabilityContractReference<CommandClient, CommandProvider, InteractionDependencyInvoker> = { kind: "lenso.capability", ...bindCommandDependency(), capability_id: CAPABILITY_ID, descriptor_version: DESCRIPTOR_VERSION, descriptor_digest: DESCRIPTOR_DIGEST, generated_client: "CommandClient", descriptor: { capability_id: CAPABILITY_ID, descriptor_version: DESCRIPTOR_VERSION, operations: ["catalog", "execute"], stream_operations: ["execute"], event_operations: [] }, bindProvider: bindCommandProvider, required(id) { return { kind: "lenso.dependency", ...(id === undefined ? {} : { id }), contract: this, cardinality: "one" }; }, optional(id) { return { kind: "lenso.dependency", ...(id === undefined ? {} : { id }), contract: this, cardinality: "optional" }; }, many(id) { return { kind: "lenso.dependency", ...(id === undefined ? {} : { id }), contract: this, cardinality: "many" }; }, };
export const COMMAND_CONTRACT = Command;
...
export function bindCommandProvider(
...
export type Provider = CommandProvider;
export const bindProvider = bindCommandProvider;
...
export function bindCommandDependency(): CapabilityDependencyBinding<CommandClient, InteractionDependencyInvoker> {
  return {
    descriptor: {
      capability_id: CAPABILITY_ID,
      descriptor_version: DESCRIPTOR_VERSION,
...
export const bindDependency = bindCommandDependency;
